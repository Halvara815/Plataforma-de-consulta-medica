import{e,j as g,s as b,q as v,i as x,c as y,k as $,f as r}from"./index-kGilWOpK.js";import{c as f}from"./card-DxPzD0eG.js";function h({tabs:n,activeId:t,onChange:s,panelHtml:a}){const o=document.createElement("div");o.className="tabs-wrapper",i();function i(){const c=n.map(d=>`<button type="button" class="tab-btn${d.id===t?" is-active":""}" data-tab="${d.id}" role="tab" aria-selected="${d.id===t}">${e(d.label)}</button>`).join("");o.innerHTML=`
